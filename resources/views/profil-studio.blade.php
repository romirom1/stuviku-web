    ...
    <div class="kontent">
        ...
        <div class="row penilaian-studio">
            <div class="col-md-12 col-penilaian">
                <!--<button class="btn btn-default btn-penilaian" type="button">Beri Penilaian</button>--><span>{{ Auth::user()->rating }}/5 </span>
                <p>Penilaian </p>
            </div>
        </div>
        <div class="row foto-profil-studio">
            <div class="col-md-3 col-profil-studio">
                ...
                <div class="bungkus-motto">
                    <p>"{{ Auth::user()->motto }}" </p><img src="{{ asset('assets/img/camera.png') }}" class="img-motto"></div>
            </div>
