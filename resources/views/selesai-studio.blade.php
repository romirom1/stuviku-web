...
<div class="col-md-9 col-sm-9 col-heading-edit-studio">
                ...
                <a class="btn btn-default btn-permintaan-masuk-studio btn-selesai" type="button" href="{{ route('studio.selesai') }}">Selesai </a>
                <hr>
            </div>
@endsection
@section('content')
            <div class="col-md-9 col-sm-9">
                @foreach ($pemesanan as $element)
                    ...
                    <div class="col-md-1 col-sm-2 col-heading-proses"><img src="@if(App\Costumer::find($element->id_costumer)->{'foto profil'}===null)
                    {{ asset('assets/img/user.png') }}
                    @else                    
                    {{ asset('photo')}}/{{ App\Costumer::find($element->id_costumer)->{'foto profil'} }}
                    @endif"></div>
                    <div class="col-md-11 col-sm-7 col-heading-proses">
                        <h3>{{ App\Costumer::find($element->id_costumer)->{'nama lengkap'} }}</h3>
                ...
                <div class="row row-permintaan">
                    ...
                    <div class="col-md-4 col-harga-proses"><span>Total Pembayaran :</span>
                        ...
                        <a class="btn btn-default btn-hubungi-cust" href="{{ route('profilcost',['id'=>App\Costumer::find($element->id_costumer)->id]) }}" target="blank" type="button">Hubungi Customer</a>
                    </div>
                </div>
                <br>
                @endforeach
